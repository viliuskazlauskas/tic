...
/* package tic-0.1.0.0 */
#define VERSION_tic "0.1.0.0"
#define MIN_VERSION_tic(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package aeson-1.0.2.0 */
#define VERSION_aeson "1.0.2.0"
...
/* package http-client-0.5.3.2 */
#define VERSION_http_client "0.5.3.2"
...
#define CURRENT_COMPONENT_ID "tic-0.1.0.0-FOxgNA1UeTn1Zc2Sr49vTD"

#define CURRENT_PACKAGE_KEY "tic-0.1.0.0-FOxgNA1UeTn1Zc2Sr49vTD"
